...
.. list-table::
    ...
    * - Write
        ...
        - :obj:`Card.identification_led_enable`,
          :obj:`Card.identification_led_disable`
    * - Read
        - :obj:`SPC_CARDIDENTIFICATION`
...
.. list-table::
    ...
    * - Direction
        ...
        - Equivalent method
    * - Read
        - :obj:`SPC_PCIFEATURES`, :obj:`SPC_PCIEXTFEATURES`,
          :obj:`SPC_READAOFEATURES`, :obj:`SPC_SEQMODE_AVAILFEATURES`
...
.. list-table::
    ...
    * - Write
        - :obj:`SPC_CARDMODE`
        - :obj:`Card.use_mode_single`, :obj:`Card.use_mode_multi`,
          :obj:`Card.use_mode_gate`, :obj:`Card.use_mode_single_restart`,
          :obj:`Card.use_mode_sequence`, :obj:`Card.use_mode_fifo_single`,
          :obj:`Card.use_mode_fifo_multi`, :obj:`Card.use_mode_fifo_gate`
    * - Read
        - :obj:`SPC_CARDMODE`
...
.. list-table::
    ...
    * - Write
        - :obj:`SPC_CLOCKMODE`
        - :obj:`Card.use_clock_primary_internal`,
          :obj:`Card.use_clock_secondary_internal`,
          :obj:`Card.use_clock_external_reference`,
          :obj:`Card.use_clock_pxie_reference`
    * - Read
        - :obj:`SPC_CLOCKMODE`
...
.. list-table::
    ...
    * - Write
        - :obj:`SPC_TRIG_TERM`
        - :obj:`Card.trigger_impedance_use_high`,
          :obj:`Card.trigger_impedance_use_50`
    * - Read
        - :obj:`SPC_TRIG_TERM`
        - :obj:`Card.get_trigger_impedance`
    * - Write
        - :obj:`SPC_TRIG_EXT0_ACDC`
        - :obj:`Card.trigger_coupling_use_dc`,
          :obj:`Card.trigger_coupling_use_ac`
    * - Read
        - :obj:`SPC_TRIG_EXT0_ACDC`
        - :obj:`Card.get_trigger_coupling`
    * - Write
        - :obj:`SPC_TRIG_EXT0_MODE`
        - :obj:`Card.trigger_disable`, :obj:`Card.use_trigger_positive_edge`,
          :obj:`Card.use_trigger_negative_edge`,
          :obj:`Card.use_trigger_both_edge`,
          :obj:`Card.use_trigger_enter_window`,
          :obj:`Card.use_trigger_leave_window`,
          :obj:`Card.use_trigger_high_gate`, :obj:`Card.use_trigger_low_gate`,
          :obj:`Card.use_trigger_inside_window_gate`,
...
.. list-table::
    ...
    * - Write
        - :obj:`SPCM_X0_MODE`
        - :obj:`Card.io_port_disable`, :obj:`Card.use_io_mode_digital_out`,
          :obj:`Card.use_io_mode_asynchronous_input`,
          :obj:`Card.use_io_mode_asynchronous_output`,
          :obj:`Card.use_io_mode_trigger_output`,
          :obj:`Card.use_io_mode_run_state_output`,
          :obj:`Card.use_io_mode_arm_state_output`,
          :obj:`Card.use_io_mode_continuous_marker_output`,
          :obj:`Card.use_io_mode_reference_clock_output`,
          :obj:`Card.use_io_mode_system_clock_output`
    * - Read
        - :obj:`SPCM_X0_MODE`
...
class Card:
    ...
    def __init__(self, device_address=b"/dev/spcm0"):
        self.is_alive = False
        self.card_handle = spcm.spcm_hOpen(
            spcm.create_string_buffer(device_address))
    ...
    def _handle_error(self, error_message):
        if not error_message:
            return
        is_remote = (
            (error_message & spcm.SPCM_ERROR_ORIGIN_MASK)
            == spcm.SPCM_ERROR_ORIGIN_REMOTE
        )
        ...
        error_dictionary = {
            spcm.ERR_INIT: "ERR_INIT: An error occurred when initializing "
                           "the given card. Either the card has already "
                           "been opened by another process or an hardware "
                           "error occurred.",
            spcm.ERR_NR: "ERR_NR",
            spcm.ERR_TYP: "ERR_TYP: Initialization only: The type of board "
                          "is unknown. This is a critical error. Please check "
                          "whether the board is correctly plugged in the slot "
                          "and whether you have the latest driver version.",
            spcm.ERR_FNCNOTSUPPORTED: "ERR_FNCNOTSUPPORTED: This function is "
                                      "not supported by the hardware version.",
            spcm.ERR_BRDREMAP: "ERR_BRDREMAP: The board index re map table in "
                               "the registry is wrong. Either delete this "
                               "table or check it carefully for double "
                               "values.",
            spcm.ERR_KERNELVERSION: "ERR_KERNELVERSION: The version of the "
                                    "kernel driver is not matching the "
                                    "version of the DLL. Please do a complete "
                                    "re-installation of the hardware driver. "
                                    "This error normally only occurs if "
                                    "someone copies the driver library and "
                                    "the kernel driver manually.",
            spcm.ERR_HWDRVVERSION: "ERR_HWDRVVERSION: The hardware needs a "
                                   "newer driver version to run properly. "
                                   "Please install the driver that was "
                                   "delivered together with the card.",
            spcm.ERR_ADRRANGE: "ERR_ADRRANGE: One of the address ranges is "
                               "disabled (fatal error), can only occur under "
                               "Linux.",
            spcm.ERR_INVALIDHANDLE: "ERR_INVALIDHANDLE: The used handle is "
                                    "not valid.",
            spcm.ERR_BOARDNOTFOUND: "ERR_BOARDNOTFOUND: A card with the given "
                                    "name has not been found.",
            spcm.ERR_BOARDINUSE: "ERR_BOARDINUSE: A card with given name is "
                                 "already in use by another application.",
            spcm.ERR_EXPHW64BITADR: "ERR_EXPHW64BITADR: Express hardware "
                                    "version not able to handle 64 bit "
                                    "addressing -> update needed.",
            spcm.ERR_FWVERSION: "ERR_FWVERSION: Firmware versions of "
                                "synchronized cards or for this driver do not "
                                "match -> update needed.",
            spcm.ERR_SYNCPROTOCOL: "ERR_SYNCPROTOCOL: Synchronization "
                                   "protocol versions of synchronized cards "
                                   "do not match -> update needed",
            spcm.ERR_KERNEL: "ERR_KERNEL",
            spcm.ERR_LASTERR: "ERR_LASTERR: Old error waiting to be read. "
                              "Please read the full error information before "
                              "proceeding. The driver is locked until the "
                              "error information has been read.",
            spcm.ERR_ABORT: "ERR_ABORT: Abort of wait function. This return "
                            "value just tells that the function has been "
                            "aborted from another thread. The driver library "
                            "is not locked if this error occurs.",
            spcm.ERR_BOARDLOCKED: "ERR_BOARDLOCKED: The card is already in "
                                "access and therefore locked by another "
                                "process. It is not possible to access one "
                                "card through multiple processes. Only one "
                                "process can access a specific card at the "
                                "time.",
            spcm.ERR_DEVICE_MAPPING: "ERR_DEVICE_MAPPING: The device is "
                                     "mapped to an invalid device. The device "
                                     "mapping can be accessed via the Control "
                                     "Center.",
            spcm.ERR_NETWORKSETUP: "ERR_NETWORKSETUP: The network setup of a "
                                   "digitizerNETBOX has failed.",
            spcm.ERR_NETWORKTRANSFER: "ERR_NETWORKTRANSFER: The network data "
                                      "transfer from/to a digitizerNETBOX has "
                                      "failed.",
            spcm.ERR_FWPOWERCYCLE: "ERR_FWPOWERCYCLE: Power cycle (PC off/on) "
                                   "is needed to update the card's firmware "
                                   "(a simple OS reboot is not sufficient !)",
            spcm.ERR_NETWORKTIMEOUT: "ERR_NETWORKTIMEOUT : A network timeout "
                                     "has occurred.",
            spcm.ERR_BUFFERSIZE: "ERR_BUFFERSIZE: The buffer size is not "
                                 "sufficient (too small).",
            spcm.ERR_RESTRICTEDACCESS: "ERR_RESTRICTEDACCESS: The access to "
                                       "the card has been intentionally "
                                       "restricted.",
            spcm.ERR_INVALIDPARAM: "ERR_INVALIDPARAM: An invalid parameter "
                                   "has been used for a certain function.",
            spcm.ERR_TEMPERATURE: "ERR_TEMPERATURE: The temperature of at "
                                  "least one of the card's sensors measures a "
                                  "temperature, that is too high for the "
                                  "hardware.",
            spcm.ERR_FAN: "ERR_FAN",
            spcm.ERR_REG: "ERR_REG: The register is not valid for this type "
                          "of board",
            spcm.ERR_VALUE: "ERR_VALUE: The value for this register is not in "
                            "a valid range. The allowed values and ranges are "
                            "listed in the board specific documentation.",
            spcm.ERR_FEATURE: "RR_FEATURE: Feature (option) is not installed "
                              "on this board. It's not possible to access "
                              "this feature if it's not installed.",
            spcm.ERR_SEQUENCE: "ERR_SEQUENCE: Command sequence is not "
                               "allowed. Please check the manual carefully to "
                               "see which command sequences are possible.",
            spcm.ERR_READABORT: "ERR_READABORT: Data read is not allowed "
                                "after aborting the data acquisition.",
            spcm.ERR_NOACCESS: "ERR_NOACCESS: Access to this register is "
                               "denied. This register is not accessible for "
                               "users.",
            spcm.ERR_POWERDOWN: "ERR_POWERDOWN",
            spcm.ERR_TIMEOUT: "ERR_TIMEOUT: A timeout occurred while waiting "
                              "for an interrupt. This error does not lock the "
                              "driver.",
            spcm.ERR_CALLTYPE: "ERR_CALLTYPE: The access to the register is "
                               "only allowed with one 64 bit access but not "
                               "with the multiplexed 32 bit (high and low "
                               "double word) version.",
            spcm.ERR_EXCEEDSINT32: "ERR_EXCEEDSINT32: The return value is "
                                   "int32 but the software register exceeds "
                                   "the 32 bit integer range. Use double "
                                   "int32 or int64 accesses instead, to get "
                                   "correct return values.",
            spcm.ERR_NOWRITEALLOWED: "ERR_NOWRITEALLOWED: The register that "
                                     "should be written is a read-only "
                                     "register. No write accesses are "
                                     "allowed.",
            spcm.ERR_SETUP: "ERR_SETUP: The programmed setup for the card is "
                            "not valid. The error register will show you "
                            "which setting generates the error message. This "
                            "error is returned if the card is started or the "
                            "setup is written.",
            spcm.ERR_CLOCKNOTLOCKED: "ERR_CLOCKNOTLOCKED: Synchronization to "
                                     "external clock failed: no signal "
                                     "connected or signal not stable. Please "
                                     "check external clock or try to use a "
                                     "different sampling clock to make the "
                                     "PLL locking easier.",
            spcm.ERR_MEMINIT: "ERR_MEMINIT: On-board memory initialization "
                              "error. Power cycle the PC and try another PCIe "
                              "slot (if possible). In case that the error "
                              "persists, please contact Spectrum support for "
                              "further assistance.",
            spcm.ERR_POWERSUPPLY: "ERR_POWERSUPPLY: On-board power supply "
                                  "error. Power cycle the PC and try another "
                                  "PCIe slot (if possible). In case that the "
                                  "error persists, please contact Spectrum "
                                  "support for further assistance.",
            spcm.ERR_ADCCOMMUNICATION: "ERR_ADCCOMMUNICATION: Communication "
                                       "with ADC failed. Power cycle the PC "
                                       "and try another PCIe slot (if "
                                       "possible). In case that the error "
                                       "persists, please contact Spectrum "
                                       "support for further assistance.",
            spcm.ERR_CHANNEL: "ERR_CHANNEL: The channel number may not be "
                              "accessed on the board: Either it is not a "
                              "valid channel number or the channel is not "
                              "accessible due to the current setup (e.g. Only "
                              "channel 0 is accessible in interlace mode)",
            spcm.ERR_NOTIFYSIZE: "ERR_NOTIFYSIZE: The notify size of the last "
                                 "spcm_dwDefTransfer call is not valid. The "
                                 "notify size must be a multiple of the page "
                                 "size of 4096. For data transfer it may also "
                                 "be a fraction of 4k in the range of 16, 32, "
                                 "64, 128, 256, 512, 1k or 2k. For ABA and "
                                 "timestamp the notify size can be 2k as a "
                                 "minimum.",
            spcm.ERR_RUNNING: "ERR_RUNNING: The board is still running, this "
                              "function is not available now or this register "
                              "is not accessible now.",
            spcm.ERR_ADJUST: "ERR_ADJUST: Automatic card calibration has "
                             "reported an error. Please check the card "
                             "inputs.",
            spcm.ERR_PRETRIGGERLEN: "ERR_PRETRIGGERLEN: The calculated "
                                    "pretrigger size (resulting from the user "
                                    "defined posttrigger values) exceeds the "
                                    "allowed limit.",
            spcm.ERR_DIRMISMATCH: "ERR_DIRMISMATCH: The direction of card and "
                                  "memory transfer mismatch. In normal "
                                  "operation mode it is not possible to "
                                  "transfer data from PC memory to card if "
                                  "the card is an acquisition card nor it is "
                                  "possible to transfer data from card to PC "
                                  "memory if the card is a generation card.",
            spcm.ERR_POSTEXCDSEGMENT: "ERR_POSTEXCDSEGMENT: The posttrigger "
                                      "value exceeds the programmed segment "
                                      "size in multiple recording/ABA mode. A "
                                      "delay of the multiple recording "
                                      "segments is only possible by using the "
                                      "delay trigger!",
            spcm.ERR_SEGMENTINMEM: "ERR_SEGMENTINMEM: Memsize is not a "
                                   "multiple of segment size when using "
                                   "Multiple Recording/Replay or ABA mode. "
                                   "The programmed segment size must match "
                                   "the programmed memory size.",
            spcm.ERR_MULTIPLEPW: "ERR_MULTIPLEPW: Multiple pulsewidth "
                                 "counters used but card only supports one at "
                                 "the time.",
            spcm.ERR_NOCHANNELPWOR: "ERR_NOCHANNELPWOR: The channel "
                                    "pulsewidth on this card can’t be used "
                                    "together with the OR conjunction. Please "
                                    "use the AND conjunction of the channel "
                                    "trigger sources.",
            spcm.ERR_ANDORMASKOVRLAP: "ERR_ANDORMASKOVRLAP: Trigger AND mask "
                                      "and OR mask overlap in at least one "
                                      "channel. Each trigger source can only "
                                      "be used either in the AND mask or in "
                                      "the OR mask, no source can be used for "
                                      "both.",
            spcm.ERR_ANDMASKEDGE: "RR_ANDMASKEDGE: One channel is activated "
                                  "for trigger detection in the AND mask but "
                                  "has been programmed to a trigger mode "
                                  "using an edge trigger. The AND mask can "
                                  "only work with level trigger modes.",
            spcm.ERR_ORMASKLEVEL: "RR_ORMASKLEVEL: One channel is activated "
                                  "for trigger detection in the OR mask but "
                                  "has been programmed to a trigger mode "
                                  "using a level trigger. The OR mask can "
                                  "only work together with edge trigger "
                                  "modes.",
            spcm.ERR_EDGEPERMOD: "ERR_EDGEPERMOD: This card is only capable "
                                 "to have one programmed trigger edge for "
                                 "each module that is installed. It is not "
                                 "possible to mix different trigger edges on "
                                 "one module.",
            spcm.ERR_DOLEVELMINDIFF: "ERR_DOLEVELMINDIFF: The minimum "
                                     "difference between low output level and "
                                     "high output level is not reached.",
            spcm.ERR_STARHUBENABLE: "ERR_STARHUBENABLE: The card holding the "
                                    "star-hub must be enabled when doing "
                                    "synchronization",
            spcm.ERR_PATPWSMALLEDGE: "ERR_PATPWSMALLEDGE: Combination of "
                                     "pattern with pulsewidth smaller and "
                                     "edge is not allowed.",
            spcm.ERR_XMODESETUP: "ERR_XMODESETUP: The chosen setup for "
                                 "(SPCM_X0_MODE .. SPCM_X19_MODE) is not "
                                 "valid. See hardware manual for details.",
            spcm.ERR_AVRG_TDA: "ERR_AVRG_LSA: Setup for Average LSA Mode not "
                               "valid. Check Threshold and Replacement values "
                               "for chosen AVRGMODE.",
            spcm.ERR_NOPCI: "ERR_NOPCI",
            spcm.ERR_PCIVERSION: "ERR_PCIVERSION",
            spcm.ERR_PCINOBOARDS: "ERR_PCINOBOARDS",
            spcm.ERR_PCICHECKSUM: "ERR_PCICHECKSUM: The check sum of the card "
                                  "information has failed. This could be a "
                                  "critical hardware failure. Restart the "
                                  "system and check the connection of the "
                                  "card in the slot.",
            spcm.ERR_DMALOCKED: "ERR_DMALOCKED",
            spcm.ERR_MEMALLOC: "ERR_MEMALLOC: Internal memory allocation "
                               "failed. Please restart the system and be sure "
                               "that there is enough free memory.",
            spcm.ERR_EEPROMLOAD: "ERR_EEPROMLOAD: Timeout occurred while "
                                 "loading information from the on-board "
                                 "EEProm. This could be a critical hardware "
                                 "failure. Please restart the system and "
                                 "check the PCI connector.",
            spcm.ERR_CARDNOSUPPORT: "ERR_CARDNOSUPPORT: The card that has "
                                    "been found in the system seems to be a "
                                    "valid Spectrum card of a type that is "
                                    "supported by the driver but the driver "
                                    "did not find this special type "
                                    "internally. Please get the latest driver "
                                    "from www.spectrum-instrumentation.com "
                                    "and install this one.",
            spcm.ERR_CONFIGACCESS: "ERR_CONFIGACCESS: Internal error occurred "
                                   "during config writes or reads. Please "
                                   "contact Spectrum support for further "
                                   "assistance",
            spcm.ERR_FIFOBUFOVERRUN: "ERR_FIFOBUFOVERRUN",
            spcm.ERR_FIFOHWOVERRUN: "ERR_FIFOHWOVERRUN: FIFO acquisition: "
                                    "Hardware buffer overrun in FIFO mode. "
                                    "The complete on-board memory has been "
                                    "filled with data and data wasn’t "
                                    "transferred fast enough to PC memory. "
                                    "FIFO replay: Hardware buffer underrun in "
                                    "FIFO mode. The complete on-board memory "
                                    "has been replayed and data wasn’t "
                                    "transferred fast enough from PC memory. "
                                    "If acquisition or replay throughput is "
                                    "lower than the theoretical bus "
                                    "throughput, check the application buffer "
                                    "setup.",
            spcm.ERR_FIFOFINISHED: "ERR_FIFOFINISHED: FIFO transfer has been "
                                   "finished, programmed data length has been "
                                   "transferred completely.",
            spcm.ERR_FIFOSETUP: "ERR_FIFOSETUP",
            spcm.ERR_TIMESTAMP_SYNC: "ERR_TIMESTAMP_SYNC: Synchronization to "
                                     "timestamp reference clock failed. "
                                     "Please check the connection and the "
                                     "signal levels of the reference clock "
                                     "input.",
            spcm.ERR_STARHUB: "ERR_STARHUB: The auto routing function of the "
                              "Star-Hub initialization has failed. Please "
                              "check whether all cables are mounted correctly",
            spcm.ERR_INTERNAL_ERROR: "ERR_INTERNAL_ERROR: Internal hardware "
                                     "error detected. Please check for driver "
                                     "and firmware update of the card."
        }
        if error_message_short in error_dictionary:
            error_message_short = error_dictionary[error_message_short]
        raise exception_type(
            f"Spectrum Instruments device error {error_message}:\n"
            f"{'Remote' if is_remote else 'Local'} device error.\n"
            f"{error_message_short}")
    ...
    def _get_int32(self, address):
        ...
        self._handle_error(
            spcm.spcm_dwGetParam_i32(
                self.card_handle, address, spcm.byref(response)))
    ...
    def _set_int32(self, address, message):
        ...
        self._handle_error(
            spcm.spcm_dwSetParam_i32(
                self.card_handle, address, spcm.int32(message)))
    ...
    def _set_int64(self, address, message):
        ...
        self._handle_error(
            spcm.spcm_dwSetParam_i64(
                self.card_handle, address, spcm.int64(message)))

    def _transfer_array_i64(
            self, buffer_type, direction, notify_size, host_address,
            device_address, data_size):
        self._handle_error(
            spcm.spcm_dwDefTransfer_i64(
                self.card_handle, buffer_type, direction, notify_size,
                host_address, device_address, data_size
            )
        )
    ...
    def get_card_type(self):
        ...
        For decoded information, use :obj:`get_name` and
        :obj:`get_series_information` instead.
    ...
    def get_production_date(self):
        ...
        For decoded information, use :obj:`get_production_date_information`
        instead.
    ...
    def get_production_date_information(self):
        ...
        date : :obj:`dict`
            ...
            :obj:`"Year"` is an :obj:`int` which contains the year the card was
            produced.
            :obj:`"Week"` is an :obj:`int` which contains the week of the year
    ...
    def get_calibration_date(self):
        ...
        For decoded information, use :obj:`get_calibration_date_information`
        instead.
    ...
    def get_is_demo_card(self):
        """
        Reads :obj:`SPC_MIINST_ISDEMOCARD` to find out if the card is a "demo"
        card (i.e., a software emulation).
    ...
    def set_card_identification(self, value):
        """
        Writes to :obj:`SPC_CARDIDENTIFICATION` to set or unset the card's
        notification LED to identification mode.
        You may want to use :obj:`identification_led_enable` and
        :obj:`identification_led_disable` instead.
    ...
    def identification_led_enable(self):
        """
        Writes to :obj:`SPC_CARDIDENTIFICATION` to set the card's notification
        LED to identification mode.
        """
    ...
    def get_card_identification(self):
        """
        Reads :obj:`SPC_CARDIDENTIFICATION` to see if the card's notification
        LED is in identification mode.
    ...
    def get_temperature_base(self, unit="C"):
        """
        Reads :obj:`SPC_MON_TK_BASE_CTRL`, :obj:`SPC_MON_TC_BASE_CTRL` or
        :obj:`SPC_MON_TF_BASE_CTRL`.

        Parameters
        ----------
        unit : :obj:`str`
            Either :obj:`"K"` for temperature in Kelvin, :obj:`"C"` for
            temperature in Celsius (default), or :obj:`"F"` for temperature
            in Fahrenheit.
        ...
        if unit == "F":
            unit_offset = 2
        return self._get_int32(
            spcm.SPC_MON_TK_BASE_CTRL
            + (spcm.SPC_MON_TC_BASE_CTRL - spcm.SPC_MON_TK_BASE_CTRL)
            * unit_offset
        )

    def get_temperature_module_0(self, unit="C"):
        """
        Reads :obj:`SPC_MON_TK_MODULE_0`, :obj:`SPC_MON_TC_MODULE_0` or
        :obj:`SPC_MON_TF_MODULE_0`.

        Parameters
        ----------
        unit : :obj:`str`
            Either :obj:`"K"` for temperature in Kelvin, :obj:`"C"` for
            temperature in Celsius (default), or :obj:`"F"` for temperature in
            Fahrenheit.
    ...
    def get_temperature_module_1(self, unit="C"):
        """
        Reads :obj:`SPC_MON_TK_MODULE_1`, :obj:`SPC_MON_TC_MODULE_1` or
        :obj:`SPC_MON_TF_MODULE_1`.
    ...
    def get_pci_information(self):
        ...
        -------
        version : :obj:`dict`
            Contains two entries: :obj:`"Hardware version"` and :obj:`"Firmware
            version"`.
        """
        bitmap = self.get_pci_version()
        return {
            "Hardware version": (bitmap >> 16),
            "Firmware version": bitmap & 0xFFFF
        }
    ...
    def get_extension_pci_version(self):
        ...
        For decoded information, use :obj:`get_extension_pci_information`
        instead.
    ...
    def get_firmware_version_control(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_control_information` instead.
    ...
    def get_firmware_version_control_information(self):
        ...
        -------
        version : :obj:`dict`
            Contains two entries: :obj:`"Firmware type"` and :obj:`"Firmware
            version"`.
        """
        bitmap = self.get_firmware_version_control()
        return {
            "Firmware type": (bitmap >> 16),
            "Firmware version": bitmap & 0xFFFF
        }
    ...
    def get_firmware_version_control_golden(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_control_golden_information` instead.
    ...
    def get_firmware_version_control_active(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_control_active_information` instead.
    ...
    def get_firmware_version_control_active_information(self):
        ...
        return {
            "Firmware type": (bitmap >> 28),
            "Firmware version": ((bitmap >> 16) & 0xFFF)
        }
    ...
    def get_firmware_version_clock(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_clock_information` instead.
    ...
    def get_firmware_version_clock_information(self):
        ...
        -------
        version : :obj:`dict`
            Contains two entries: :obj:`"Firmware type"` and
            :obj:`"Firmware version"`.
        """
    ...
    def get_firmware_version_configuration(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_configuration_information` instead.
    ...
    def get_firmware_version_module_a(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_module_a_information` instead.
    ...
    def get_firmware_version_module_b(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_module_b_information` instead.
    ...
    def get_firmware_version_module_star(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_module_star_information` instead.
    ...
    def get_firmware_version_power(self):
        ...
        For decoded information, use
        :obj:`get_firmware_version_power_information` instead.
    ...
    def get_driver_version_information(self):
        ...
        return f"{driver_version >> 24}.{(driver_version >> 16) & 0xFF} " \
               f"build {(driver_version) & 0xFFFF}"
    ...
    def get_kernel_version_information(self):
        ...
        return f"{kernel_version >> 24}.{(kernel_version >> 16) & 0xFF}" \
               f"build {(kernel_version) & 0xFFFF}"
    ...
    def get_modifications(self):
        ...
        For decoded information, use :obj:`get_modifications_information`
        instead.
    ...
    def get_modifications_information(self):
        ...
        modifications : :obj:`dict`
            Contains three entries for modifications for different parts of the
            card: :obj:`"Card"`, :obj:`"Front-end"`, and :obj:`"Star-hub"`.
        """
    ...
    def get_features_information(self):
        """
        Reads :obj:`SPC_PCIFEATURES`, :obj:`SPC_PCIEXTFEATURES`,
        :obj:`SPC_READAOFEATURES`, and :obj:`SPC_SEQMODE_AVAILFEATURES`
        and displays each feature of the card in a list.
    ...
    def get_functions_information(self):
        """
        Reads :obj:`SPC_FNCTYP` and displays each function of the card in a
        list.
    ...
    def set_mode(self, mode):
        ...
        To do this without using bit codes, use :obj:`use_mode_single`,
        :obj:`use_mode_multi`,
        :obj:`use_mode_gate`, :obj:`use_mode_single_restart`,
        :obj:`use_mode_sequence`, :obj:`use_mode_fifo_single`,
        :obj:`use_mode_fifo_multi`, or :obj:`use_mode_fifo_gate` instead.
    ...
    def use_mode_single(self):
        """
        Writes to :obj:`SPC_CARDMODE` to set the mode of the card to
        :obj:`SPC_REP_STD_SINGLE`.
        """
    ...
    def get_mode_information(self):
        """
        Reads :obj:`SPC_CARDMODE` and displays the current card mode as a
        :obj:`str`.
    ...
    def get_available_modes(self):
        ...
        For decoded information, use :obj:`get_available_modes_information`
        instead.
    ...
    def get_available_modes_information(self):
        """
        Reads :obj:`SPC_AVAILCARDMODES` and displays each available mode for
        the card in a list.
    ...
    def set_sample_rate(self, sample_rate, multiplier=""):
        ...
        multiplier : :obj:`str`
            Can be metric prefixes :obj:`""` (default), :obj:`"k"`,
            :obj:`"M"` or :obj:`"G"`.
        """
        if multiplier == "k":
            sample_rate *= 1e3
            ...
            raise ValueError(
                "multiplier must be either \"k\", \"M\", \"G\" or \"\".")
    ...
    def set_clock_output(self, enable):
        ...
        You may instead want to use :obj:`clock_output_enable` and
        :obj:`clock_output_disable`.
    ...
    def set_external_reference_frequency(self, frequency, multiplier=""):
        ...
        multiplier : :obj:`str`
            Can be metric prefixes :obj:`""` (default), :obj:`"k"`, :obj:`"M"`
            or :obj:`"G"`.
        """
        if multiplier == "k":
            frequency *= 1e3
    ...
    def get_available_clock_modes(self):
        ...
        For decoded information, use
        :obj:`get_available_clock_modes_information` instead.
    ...
    def get_available_clock_modes_information(self):
        """
        Reads :obj:`SPC_AVAILCLOCKMODES` and displays each available mode for
        the clock in a list.
    ...
    def set_clock_mode(self, clock_mode):
        ...
        To do this without using bit codes, use
        :obj:`use_clock_primary_internal`,
        :obj:`use_clock_secondary_internal`,
        :obj:`use_clock_external_reference`, or :obj:`use_clock_pxie_reference`
        instead.
    ...
    def get_clock_mode_information(self):
        """
        Reads :obj:`SPC_CLOCKMODE` and displays the current clock mode as a
        string.
    ...
    def get_sufficient_triggers(self):
        """
        Reads :obj:`SPC_TRIG_ORMASK` and displays each sufficient trigger in a
        :obj:`list` of :obj:`str`.
    ...
    def get_available_triggers_for_or_mask(self):
        ...
        For decoded information, use :obj:`get_available_sufficient_triggers`
        instead.
    ...
    def get_available_sufficient_triggers(self):
        """
        Reads :obj:`SPC_TRIG_AVAILORMASK` and displays each available
        sufficient trigger in a :obj:`list` of :obj:`str`.

        Returns
        -------
        features : :obj:`list` of :obj:`str`
            A list of each available sufficient trigger written as a
            :obj:`str`.
        """
    ...
    def set_channels_triggered_by_or_mask(self, mask):
        ...
        To do this without using bit codes, use
        :obj:`set_channels_for_sufficient_triggers`.
    ...
    def set_channels_for_sufficient_triggers(
        ...
        """
        Writes to :obj:`SPC_TRIG_CH_ORMASK0`.
        Set each parameter to :obj:`True` to add the channel to those affected
        by the OR mask.
        """
        mask = 0
        if channel_0:
    ...
    def get_channels_triggered_by_or_mask(self):
        ...
        For decoded information, use
        :obj:`get_channels_for_sufficient_triggers` instead.
    ...
    def get_channels_for_sufficient_triggers(self):
        """
        Reads :obj:`SPC_TRIG_CH_ORMASK0` and displays each channel in a
        :obj:`list` of :obj:`str`.
    ...
    def get_available_channels_triggered_by_or_mask(self):
        ...
        For decoded information, use
        :obj:`get_available_channels_for_sufficient_triggers` instead.
    ...
    def get_available_channels_for_sufficient_triggers(self):
        """
        Reads :obj:`SPC_TRIG_CH_AVAILORMASK0` and displays each channel in a
        :obj:`list` of :obj:`str`.
    ...
    def get_necessary_triggers(self):
        """
        Reads :obj:`SPC_TRIG_ANDMASK` and displays each necessary trigger in a
        :obj:`list` of :obj:`str`.
    ...
    def get_available_triggers_for_and_mask(self):
        ...
        For decoded information, use :obj:`get_available_necessary_triggers`
        instead.
    ...
    def get_available_necessary_triggers(self):
        """
        Reads :obj:`SPC_TRIG_AVAILANDMASK` and displays each available
        necessary trigger in a :obj:`list` of :obj:`str`.
    ...
    def set_channels_triggered_by_and_mask(self, mask):
        ...
        To do this without using bit codes, use
        :obj:`set_channels_for_necessary_triggers`.
    ...
    def set_channels_for_necessary_triggers(
        ...
        """
        Writes to :obj:`SPC_TRIG_CH_ANDMASK0`.
        Set each parameter to :obj:`True` to add the channel to those effected
        by the AND mask.
        """
        mask = 0
        if channel_0:
    ...
    def get_channels_triggered_by_and_mask(self):
        ...
        For decoded information, use :obj:`get_channels_for_necessary_triggers`
        instead.
    ...
    def get_channels_for_necessary_triggers(self):
        """
        Reads :obj:`SPC_TRIG_CH_ANDMASK0` and displays each channel in a
        :obj:`list` of :obj:`str`.
    ...
    def get_available_channels_triggered_by_and_mask(self):
        ...
        For decoded information, use
        :obj:`get_available_channels_for_necessary_triggers` instead.
    ...
    def get_available_channels_for_necessary_triggers(self):
        """
        Reads :obj:`SPC_TRIG_CH_AVAILANDMASK0` and displays each channel in a
        :obj:`list` of :obj:`str`.
    ...
    def set_trigger_input_termination(self, type):
        ...
        To do this without using bit codes, use
        :obj:`trigger_impedance_use_high` and :obj:`trigger_impedance_use_50`.
    ...
    def set_trigger_input_coupling(self, trigger_index, type):
        ...
        To do this without using bit codes, use :obj:`trigger_coupling_use_dc`
        and :obj:`trigger_coupling_use_ac`.
        ...
        """
        self._set_int32(
            spcm.SPC_TRIG_EXT0_ACDC
            + (spcm.SPC_TRIG_EXT1_ACDC - spcm.SPC_TRIG_EXT0_ACDC)
            * trigger_index, type
        )
    ...
    def set_trigger_mode(self, trigger_index, mode):
        ...
        To do this without using bit codes, use :obj:`trigger_disable`,
        :obj:`use_trigger_positive_edge`, :obj:`use_trigger_negative_edge`,
        :obj:`use_trigger_both_edge`, :obj:`use_trigger_enter_window`,
        :obj:`use_trigger_leave_window`, :obj:`use_trigger_high_gate`,
        :obj:`use_trigger_low_gate`, :obj:`use_trigger_inside_window_gate`,
        or :obj:`use_trigger_outside_window_gate`.
        ...
        """
        self._set_int32(
            spcm.SPC_TRIG_EXT0_MODE
            + (spcm.SPC_TRIG_EXT1_MODE - spcm.SPC_TRIG_EXT0_MODE)
            * trigger_index, mode
        )
    ...
    def trigger_disable(self, trigger_index, make_sufficient=True):
        ...
        make_sufficient : :obj:`bool`
            If :obj:`True` (default), removes this trigger to the OR mask (see
            :obj:`set_sufficient_triggers`).
        """
        self.set_trigger_mode(trigger_index, spcm.SPC_TM_NONE)
        if make_sufficient:
            or_mask = self.get_trigger_or_mask()
            self.set_trigger_or_mask(
                or_mask & (~((spcm.SPC_TMASK_EXT0 & 3) << trigger_index))
            )

    def use_trigger_positive_edge(
            self, trigger_index, threshold, multiplier="",
            re_arm_threshold=None, make_sufficient=True):
        """
        ...
        re_arm_threshold : :obj:`float`
            ...
            Can be set to a voltage (in units determined by :obj:`multiplier`)
            such that the trigger level must go under this threshold to be
            re-armed after a trigger (using flag :obj:`SPC_TM_REARM`).
        make_sufficient : :obj:`bool`
            If :obj:`True` (default), adds this trigger to the OR mask (see
            :obj:`set_sufficient_triggers`).
        """
        if re_arm_threshold is None:
            ...
            self.set_trigger_mode(
                trigger_index, spcm.SPC_TM_POS | spcm.SPC_TM_REARM)
            self.set_lower_trigger_threshold(
                trigger_index, re_arm_threshold, multiplier)
    ...
    def use_trigger_negative_edge(
        ...
        re_arm_threshold : :obj:`float`
            Is :obj:`None` by default.
            Can be set to a voltage (in units determined by :obj:`multiplier`)
            such that the trigger level must go over this threshold to be
            re-armed after a trigger (using flag :obj:`SPC_TM_REARM`).
        make_sufficient : :obj:`bool`
            If :obj:`True` (default), adds this trigger to the OR mask (see
            :obj:`set_sufficient_triggers`).
        ...
        if re_arm_threshold is None:
            ...
            self.set_upper_trigger_threshold(
                trigger_index, threshold, multiplier)
        else:
            self.set_trigger_mode(
                trigger_index, spcm.SPC_TM_NEG | spcm.SPC_TM_REARM)
            self.set_lower_trigger_threshold(
                trigger_index, threshold, multiplier)
            self.set_upper_trigger_threshold(
                trigger_index, re_arm_threshold, multiplier)
    ...
    def use_trigger_both_edge(
            self, trigger_index, threshold, multiplier="",
            make_sufficient=True):
        """
    ...
    def use_trigger_enter_window(
            self, trigger_index, lower_threshold, upper_threshold,
            multiplier="", make_sufficient=True):
        """
        ...
        self.set_upper_trigger_threshold(
            trigger_index, upper_threshold, multiplier)
        self.set_lower_trigger_threshold(
            trigger_index, lower_threshold, multiplier)
        if make_sufficient:
            or_mask = self.get_trigger_or_mask()
            self.set_trigger_or_mask(
                or_mask | ((spcm.SPC_TMASK_EXT0 & 3) << trigger_index))

    def use_trigger_leave_window(
            self, trigger_index, lower_threshold, upper_threshold,
            multiplier="", make_sufficient=True):
        """
    ...
    def use_trigger_high_gate(
            self, trigger_index, threshold, multiplier="",
            make_sufficient=False):
        """
        ...
        multiplier : :obj:`str`
            Can be metric prefixes :obj:`""` (default), or :obj:`"m"`.
        make_sufficient : :obj:`bool`
            If :obj:`True` (:obj:`False` is default), adds this trigger to the
            OR mask (see :obj:`set_sufficient_triggers`).
        """
    ...
    def use_trigger_inside_window_gate(
            self, trigger_index, lower_threshold, upper_threshold,
            multiplier="", make_sufficient=False):
        """
    ...
    def use_trigger_outside_window_gate(
            self, trigger_index, lower_threshold, upper_threshold,
            multiplier="", make_sufficient=False):
        """
    ...
    def get_trigger_mode(self, trigger_index):
        ...
        For decoded information, use :obj:`get_trigger_mode_information`
        instead.
        ...
        return self._get_int32(
            spcm.SPC_TRIG_EXT0_MODE
            + (spcm.SPC_TRIG_EXT1_MODE - spcm.SPC_TRIG_EXT0_MODE)*trigger_index
        )
    ...
    def get_available_trigger_modes(self, trigger_index):
        ...
        For decoded information, use
        :obj:`get_available_trigger_modes_information` instead.
    ...
    def set_upper_trigger_threshold(
            self, trigger_index, threshold, multiplier=""):
        """
        ...
        self._set_int32(
            spcm.SPC_TRIG_EXT0_LEVEL0
            + (spcm.SPC_TRIG_EXT1_LEVEL0 - spcm.SPC_TRIG_EXT0_LEVEL0)
            * trigger_index, threshold
        )
    ...
    def set_lower_trigger_threshold(
            self, trigger_index, threshold, multiplier=""):
        """
    ...
    def get_lower_trigger_threshold(self, trigger_index):
        ...
        return self._get_int32(
            spcm.SPC_TRIG_EXT0_LEVEL1
            + (spcm.SPC_TRIG_EXT1_LEVEL1 - spcm.SPC_TRIG_EXT0_LEVEL1)
            * trigger_index
        )*1e-3
    ...
    def set_amplitude(self, channel_index, amplitude, multiplier=""):
        ...
        if multiplier == "":
            ...
            raise ValueError("multiplier must be either \"m\" or \"\".")
        self._set_int32(
            spcm.SPC_AMP0 + channel_index*(spcm.SPC_AMP1 - spcm.SPC_AMP0),
            amplitude
        )
    ...
    def get_amplitude(self, channel_index):
        ...
        """
        return self._get_int32(
            spcm.SPC_AMP0 + channel_index*(spcm.SPC_AMP1 - spcm.SPC_AMP0))*1e-3
    ...
    def set_output_enable(self, channel_index, enable):
        ...
        self._set_int32(
            spcm.SPC_ENABLEOUT0
            + channel_index*(spcm.SPC_ENABLEOUT1 - spcm.SPC_ENABLEOUT0),
            enable
        )
    ...
    def set_filter(self, channel_index, enable):
        ...
        self._set_int32(
            spcm.SPC_FILTER0
            + channel_index*(spcm.SPC_FILTER1 - spcm.SPC_FILTER0), enable
        )
    ...
    def get_filter(self, channel_index):
        ...
        return self._get_int32(
            spcm.SPC_FILTER0
            + channel_index*(spcm.SPC_FILTER1 - spcm.SPC_FILTER0)
        )
    ...
    def set_differential(self, channel_index, enable):
        ...
        """
        self._set_int32(
            spcm.SPC_DIFF0 + channel_index*(spcm.SPC_DIFF1 - spcm.SPC_DIFF0),
            enable
        )
    ...
    def set_double(self, channel_index, enable):
        ...
        self._set_int32(
            spcm.SPC_DOUBLEOUT0
            + channel_index*(spcm.SPC_DOUBLEOUT1 - spcm.SPC_DOUBLEOUT0),
            enable
        )
    ...
    def set_stop_level(self, channel_index, stop_level_code):
        ...
        """
        self._set_int32(
            spcm.SPC_CH0_STOPLEVEL
            + channel_index*(spcm.SPC_CH1_STOPLEVEL - spcm.SPC_CH0_STOPLEVEL),
            stop_level_code
        )
    ...
    def set_stop_level_custom(self, channel_index, value):
        ...
        """
        self._set_int32(
            spcm.SPC_CH0_CUSTOM_STOP + channel_index
            * (spcm.SPC_CH1_CUSTOM_STOP - spcm.SPC_CH0_CUSTOM_STOP),
            value
        )
    ...
    def set_channel_stop_level(
        ...
        To set a custom value, set the parameter :obj:`custom_value` to a
        :obj:`float` between :obj:`-1.0` and :obj:`1.0`.
        To set it to any other stop level mode, set that parameter to
        :obj:`True`.
        """
        if zero:
            ...
            self.set_stop_level_custom(
                channel_index, int(limit*np.clip(custom_value, -1, 1)))
    ...
    def get_channel_stop_level(self, channel_index):
        ...
        stop_level : :obj:`str` or :obj:`float`
            If stop level is set to a particular mode, returns that mode as a
            :obj:`str`.
            If this mode is :obj:`SPCM_STOPLVL_CUSTOM` then it returns the
            custom level as a :obj:`float` between :obj:`-1.0` and :obj:`1.0`.
        """
    ...
    def arm(self):
        """
        Writes :obj:`M2CMD_CARD_START` and :obj:`M2CMD_CARD_ENABLETRIGGER` to
        :obj:`SPC_M2CMD`.
        """
    ...
    def array_to_device(
            self, data, segment=0, aux_data=None, aux_data_channels=None):
        """
        Transfers signals from the host to the card using
        :obj:`_transfer_array_i64`.

        Parameters
        ----------
        data : :obj:`list` of :obj:`numpy.ndarray` of :obj:`float`
            A :obj:`list` of sampled waveforms to be transferred to the card.
            The first element in the :obj:`list` is the waveform that is
            assigned to the first enabled channel, and so on.
            Values are assumed to be between :obj:`-1.0` and :obj:`1.0`.
        segment : :obj:`int`
            The segment that the waveform is loaded into.
            Only relevant if the card is in a mode that uses segments, such as
            sequencing.
        aux_data : :obj:`list` of :obj:`numpy.ndarray` of :obj:`bool`
            An optional :obj:`list` of binary waveforms to be played out of the
            IO ports (X0, X1 and/or X2).
            Requires information given in :obj:`aux_data_channels`.
            Will automatically set up port modes and signal discretisation
            based on information given.
        aux_data_channels : :obj:`list` of :obj:`dict`
            Information that says where in which channels the binary waveforms
            in :obj:`aux_data_channels` are taken from, and which port they are
            output.
            Each :obj:`dict` in the overall :obj:`list` corresponds to one of
            the waveforms in :obj:`aux_data_channels`.
            The dictionary should contain three elements:
            :obj:`"Port"` is an :obj:`int` that corresponds to which of the
            digital IO ports that waveform should be sent to;
            :obj:`"Channel"` is an :obj:`int` that corresponds to which of the
            channels the digital waveform should be encoded in; and
            :obj:`"Bit"` is either :obj:`15`, :obj:`14` or :obj:`13`, which
            corresponds to which bit of the channel should be sacrificed for
        ...
        data_buffer = spcm_tools.pvAllocMemPageAligned(
            channels*stride*data[0].size)
        ...
        for channel in range(channels):
            # Find out if there are digital outs and, if so, set the
            # discretisation rate
            max_bits = self.get_sample_resolution_bits()
            aux_data_reverse_lookup = []
            if aux_data is not None:
                for aux_data_channel_index, aux_data_channel in enumerate(
                        aux_data_channels):
                    if aux_data_channel["Channel"] == channel:
                        bit = aux_data_channel["Bit"]
                        max_bits = min(bit, max_bits)
                        aux_data_reverse_lookup.append(
                            [aux_data_channel_index, bit])
                        self.use_io_mode_digital_out(
                            aux_data_channel["Port"],
                            aux_data_channel["Channel"],
                            aux_data_channel["Bit"]
                        )
            ...
            if aux_data is None:
                ...
                for sample_index, sample in enumerate(channel_data):
                    # Discretise waveform, and blank out bits meant for aux
                    # digital out
                    data_pointer[channel + channels*sample_index] = \
                        int(limit*np.clip(sample, -1, 1)) \
                        & (~(0x7 << max_bits))
                    # Append aux digital outs
                    for reverse_lookup in aux_data_reverse_lookup:
                        data_pointer[channel + channels*sample_index] |= (
                            int(aux_data[reverse_lookup[0]][sample_index]) & 1
                        ) << reverse_lookup[1]
        ...
        self._transfer_array_i64(
            spcm.SPCM_BUF_DATA, spcm.SPCM_DIR_PCTOCARD, 0, data_buffer, 0,
            stride*data[0].size*channels
        )
    ...
    def get_available_sequence_features(self):
        ...
        For decoded information, use :obj:`get_features_information` or
        :obj:`get_available_sequence_features_information` instead.
    ...
    def get_available_sequence_features_information(self):
        ...
        -------
        features : :obj:`list` of :obj:`str`
            The features that can be used in sequence mode in :obj:`str`
            format.
        """
        bitmap = self.get_available_sequence_features()
        features = []
    ...
    def set_step_instruction(
        ...
        next_step : :obj:`int`
            ...
            If :obj:`None` (default), will either point to step :obj:`step + 1`
            or, if :obj:`end_of_sequence` is set to :obj:`True`, will point to
            step :obj:`0`.
    ...
    def get_step_instruction(self, step):
        ...
        instruction : :obj:`dict`
            Contains information under keys of :obj:`"Segment"`,
            :obj:`"Next step"`, :obj:`"Number of loops"`,
            :obj:`"Loop until trigger"` and :obj:`"End of sequence"`.
            Each has the same meaning as in the parameters for
            :obj:`set_step_instruction`.
        """
        ...
        return {
            ...
            "Loop until trigger": loop_until_trigger,
            "End of sequence": end_of_sequence
        }
    ...
    def set_io_mode(self, port, mode):
        ...
        To do this without using bit codes, use :obj:`io_port_disable`,
        :obj:`use_io_mode_digital_out`, :obj:`use_io_mode_asynchronous_input`,
        :obj:`use_io_mode_asynchronous_output`,
        :obj:`use_io_mode_trigger_output`,
        :obj:`use_io_mode_run_state_output`,
        :obj:`use_io_mode_arm_state_output`,
        :obj:`use_io_mode_continuous_marker_output`,
        :obj:`use_io_mode_reference_clock_output` or
        :obj:`use_io_mode_system_clock_output` instead.
        ...
        """
        self._set_int32(
            spcm.SPCM_X0_MODE + (spcm.SPCM_X1_MODE - spcm.SPCM_X0_MODE)*port,
            mode
        )
    ...
    def get_io_mode(self, port):
        ...
        For decoded information, use :obj:`get_available_io_modes_information`
        instead.
    ...
    def get_available_io_modes(self, port):
        ...
        """
        return self._get_int32(
            spcm.SPCM_X0_AVAILMODES
            + (spcm.SPCM_X1_MODE - spcm.SPCM_X0_MODE)*port
        )
